...
namespace GoHardAPI.Migrations
{
    ...
    [Migration("20260914013617_AddNutritionGoalEffectiveDate")]
    partial class AddNutritionGoalEffectiveDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoHardAPI.Models.DMConversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoHardAPI.Models.DirectMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoHardAPI.Models.FoodItem", b =>
                {
                    ...
                    b.Property<int?>("SourcePlanConversationId")
                        .HasColumnType("int");

                    b.Property<int?>("SourcePlanDay")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SourcePlanConversationId");

                    b.HasIndex("MealEntryId", "SourcePlanConversationId", "SourcePlanDay");
            ...
            modelBuilder.Entity("GoHardAPI.Models.Friendship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoHardAPI.Models.NutritionProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ConsumedCarbohydrates")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ConsumedFat")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ConsumedFiber")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ConsumedProtein")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ConsumedWater")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("PlannedCalories")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PlannedCarbohydrates")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PlannedFat")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PlannedFiber")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PlannedProtein")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PlannedWater")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GoHardAPI.Models.RunSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoHardAPI.Models.SessionCreateOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SessionCreateOperations");
                });
            ...
            modelBuilder.Entity("GoHardAPI.Models.DMConversation", b =>
                {
                    b.HasOne("GoHardAPI.Models.User", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("GoHardAPI.Models.User", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("GoHardAPI.Models.DirectMessage", b =>
                {
                    b.HasOne("GoHardAPI.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("GoHardAPI.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("GoHardAPI.Models.FoodItem", b =>
                {
                    ...
                    b.HasOne("GoHardAPI.Models.ChatConversation", "SourcePlanConversation")
                        .WithMany()
                        .HasForeignKey("SourcePlanConversationId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SourcePlanConversation");
                });
            ...
            modelBuilder.Entity("GoHardAPI.Models.Friendship", b =>
                {
                    b.HasOne("GoHardAPI.Models.User", "Addressee")
                        .WithMany()
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("GoHardAPI.Models.User", "Requester")
                        .WithMany()
            ...
            modelBuilder.Entity("GoHardAPI.Models.NutritionProgress", b =>
                {
                    b.HasOne("GoHardAPI.Models.NutritionGoal", "NutritionGoal")
                        .WithMany()
